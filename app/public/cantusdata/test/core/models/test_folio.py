...
class FolioModelTestCase(TransactionTestCase):
    ...
    def test_unicode(self):
        self.assertEqual(self.folio.__str__(), "123 - , ABC - 456")
    ...
    def test_chant_count(self):
        ...
        chant = Chant.objects.create(
            sequence=2, manuscript=self.manuscript, folio=self.folio
        )
        ...
        another_chant = Chant.objects.create(
            sequence=5, manuscript=self.manuscript, folio=self.folio
        )

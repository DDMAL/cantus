...
n){function q(){return a||!0!==l.options.disabled&&!b(this).hasClass("ui-state-disabled")?("string"==typeof n?l[n]:n).apply(l,arguments):e}"string"!=typeof n&&(q.guid=n.guid=n.guid||q.guid||b.guid++);var m=d.match(/^(\w+)\s*(.*)$/),r=m[1]+l.eventNamespace;(m=m[2])?f.delegate(m,r,q):c.bind(r,q)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b)},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"==typeof a?
...
a)})},l=function(a,d){b.support.touch?a.bind("touchstart",d.events.touchStart).bind("touchend",d.events.inputEnd).bind("touchmove",d.events.touchMove):a.mousedown(d.events.inputDown).mouseup(d.events.inputEnd).mousemove(d.events.inputMove);a.click(d.events.inputClick).scroll(d.events.scroll).bind("selectstart",c).bind("dragstart",d.events.dragStart)},k=function(c){this.addClass("kinetic-active").each(function(){var d=this,h=b(this);if(!h.data("kinetic-settings")){var f=b.extend({},e,c),k,t=!1,p,w=
!1,u=!1,F=1E3/f.throttleFPS,G,H;f.velocity=0;f.velocityY=0;var v=function(){u=p=k=!1};b(document).mouseup(v).click(v);var I=function(){f.velocity=a(t-k,f.maxvelocity);f.velocityY=a(w-p,f.maxvelocity)},y=function(a){return b.isFunction(f.filterTarget)?!1!==f.filterTarget.call(d,a):!0},x=function(a,c){if(!G||new Date>new Date(G.getTime()+F))G=new Date,u&&(k||p)&&(H&&(b(H).blur(),H=null,h.focus()),f.decelerate=!1,f.velocity=f.velocityY=0,h[0].scrollLeft=f.scrollLeft=f.x?h[0].scrollLeft-(a-k):h[0].scrollLeft,
h[0].scrollTop=f.scrollTop=f.y?h[0].scrollTop-(c-p):h[0].scrollTop,t=k,w=p,k=a,p=c,I(),g.call(h,f,f.movingClass),"function"===typeof f.moved&&f.moved.call(h,f))};f.events={touchStart:function(a){var b;if(y(a.target)){b=a.originalEvent.touches[0];var c=b.clientX;b=b.clientY;u=!0;f.velocity=t=0;f.velocityY=w=0;k=c;p=b;a.stopPropagation()}},touchMove:function(a){var b;u&&(b=a.originalEvent.touches[0],x(b.clientX,b.clientY),a.preventDefault&&a.preventDefault())},inputDown:function(a){if(y(a.target)){var b=
a.clientX,c=a.clientY;u=!0;f.velocity=t=0;f.velocityY=w=0;k=b;p=c;H=a.target;"IMG"===a.target.nodeName&&a.preventDefault();a.stopPropagation()}},inputEnd:function(a){k&&t&&!1===f.decelerate&&(f.decelerate=!0,I(),k=t=u=!1,m(h,f));H=null;a.preventDefault&&a.preventDefault()},inputMove:function(a){u&&(x(a.clientX,a.clientY),a.preventDefault&&a.preventDefault())},scroll:function(a){"function"===typeof f.moved&&f.moved.call(h,f);a.preventDefault&&a.preventDefault()},inputClick:function(a){if(0<Math.abs(f.velocity))return a.preventDefault(),
!1},dragStart:function(a){if(H)return!1}};l(h,f);h.data("kinetic-settings",f).css("cursor",f.cursor);f.triggerHardware&&h.css({"-webkit-transform":"translate3d(0,0,0)","-webkit-perspective":"1000","-webkit-backface-visibility":"hidden"})}})};b.kinetic={settingsKey:"kinetic-settings",callMethods:{start:function(a,c){var d=b(this);if(a=b.extend(a,c))a.decelerate=!1,m(d,a)},end:function(a,c){b(this);a&&(a.decelerate=!0)},stop:function(a,c){var d=b(this);h(d,a)},detach:function(a,d){var e=b(this);b.support.touch?
...
"move")}}};b.fn.kinetic=function(a){"string"===typeof a?f.apply(this,arguments):k.call(this,a);return this}})(window.jQuery||window.Zepto);
var diva=function(){var b={};return{Events:{publish:function(e,c,d){if(b[e]){e=b[e];for(var a=e.length;a--;)e[a].apply(d||this,c||[])}},subscribe:function(e,c){b[e]||(b[e]=[]);b[e].push(c);return[e,c]},unsubscribe:function(e,c){var d=e[0],a=b[d].length;if(b[d])for(;a--;)b[d][a]===e[1]&&(b[d].splice(b[d][a],1),c&&delete b[d])},isSubscribedTo:function(e,c){return"undefined"===typeof b[e]?!1:0<=b[e].indexOf(c)}}}}();window.divaPlugins=[];
...
d,X;if("function"===typeof a){c=[];d=1;for(X=arguments.length;d<X;d++)c.push(arguments[d]);b&&(console.warn('The use of callback functions is deprecated. Use diva.Events.subscribe("Event", function) instead.'),b=!1);a.apply(e,c);return!0}return!1}}(),m=function(b,c){return a.pages[b].d[a.zoomLevel][c]},f=function(b){var c,d=a.numPages;for(c=0;c<d;c++)if(a.pages[c].f===b)return c;return-1},l=function(b,c){var d=a.topScrollSoFar-a.viewportMargin,e=d+a.panelHeight+2*a.viewportMargin;return b>=d&&b<=
e||b<=d&&c>=e||c>=d&&c<=e},k=function(b){return 0<=b&&b<a.numPages},n=function(b){var c=a.heightAbovePages[b];b=c+m(b,"h")+a.verticalPadding;return l(c,b)},q=function(c){if(!(0<b(document.getElementById(a.ID+"page-"+c)).length&&a.allTilesLoaded[c])){var d=a.pages[c].f,e=m(c,"w"),g=m(c,"h"),f=a.heightAbovePages[c]+a.verticalPadding,k=a.selector+"page-"+c,v;if(!(0<b(document.getElementById(a.ID+"page-"+c)).length))for(v in b(document.getElementById(a.ID+"inner")).append('<div id="'+a.ID+"page-"+c+'" style="top: '+
f+"px; width: "+e+"px; height: "+g+'px;" class="diva-document-page" title="Page '+(c+1)+'" data-index="'+c+'" data-filename="'+d+'">'+a.pageTools+"</div>"),h(a.onPageLoad,c,d,k),diva.Events.publish("PageWillLoad",[c,d,k]),a.plugins)h(a.plugins[v].onPageLoad,c,d,k);a.pageTimeouts.push(setTimeout(function(){if(n(c)){var f=a.imageDir+"/",v=m(c,"r"),x=m(c,"c"),y=[],I=!0,R=0,J=g-(v-1)*a.tileHeight,Q=e-(x-1)*a.tileWidth,A,Y,K,q,N,t;baseImageURL=a.iipServerURL+"?FIF="+f+d+"&JTL="+(a.zoomLevel+a.pages[c].m-
a.realMaxZoom)+",";for(f=0;f<v;){for(A=0;A<x;){q=f*a.tileHeight;N=A*a.tileWidth;Y=f===v-1?J:a.tileHeight;K=A===x-1?Q:a.tileWidth;t=baseImageURL+R;if(!(0<b(a.selector+"tile-"+c+"-"+R).length)){var p=a.heightAbovePages[c]+f*a.tileHeight+a.verticalPadding,z=a.pageLeftOffsets[c]+A*a.tileWidth,r=z+a.tileWidth;if(p=l(p,p+a.tileHeight))var p=a.leftScrollSoFar-a.viewportMargin,u=p+a.panelWidth+2*a.viewportMargin,s=r>=p&&r<=u,r=z<=p&&r>=u,p=z>=p&&z<=u||r||s;p?y.push('<div id="'+a.ID+"tile-"+c+"-"+R+'" class="diva-document-tile" style="display:inline; position: absolute; top: '+
q+"px; left: "+N+"px; background-image: url('"+t+"'); height: "+Y+"px; width: "+K+'px;"></div>'):I=!1}R++;A++}f++}a.allTilesLoaded[c]=I;b(document.getElementById(a.ID+"page-"+c)).append(y.join(""));h(a.onPageLoaded,c,d,k);diva.Events.publish("PageDidLoad",[c,d,k])}},a.pageLoadTimeout))}},s=function(c){b(document.getElementById(a.ID+"page-"+c)).empty().remove()},r=function(b,c){0<c?k(b)&&(n(b)?(q(b),a.lastPageLoaded=b,r(a.lastPageLoaded+1,c)):a.heightAbovePages[b]+m(b,"h")+a.verticalPadding<a.topScrollSoFar&&
r(b+1,c)):k(b)&&(n(b)?(q(b),a.firstPageLoaded=b,r(a.firstPageLoaded-1,c)):a.heightAbovePages[b]>a.topScrollSoFar+a.panelHeight&&r(b-1,c))},L=function(b,c){0<c?k(b)&&a.heightAbovePages[b]+m(b,"h")+a.verticalPadding<a.topScrollSoFar&&(s(b),a.firstPageLoaded=b+1,L(a.firstPageLoaded,c)):k(b)&&a.heightAbovePages[b]>a.topScrollSoFar+a.panelHeight&&(s(b),a.lastPageLoaded=b-1,L(a.lastPageLoaded,c))},t=function(b){return 0<=b&&b<a.numRows},p=function(b){b*=a.rowHeight;return l(b,b+a.rowHeight+a.fixedPadding)},
w=function(c){if(!(0<b(a.selector+"row-"+c).length)){var d=[];d.push('<div class="diva-row" id="'+a.ID+"row-"+c+'" style="height: '+a.rowHeight+"; top: "+(a.rowHeight*c+a.fixedPadding)+'px;">');var e,g,f,h,v,l,x=a.imageDir+"/",y=a.pagesPerRow;for(e=0;e<y;e++){g=c*a.pagesPerRow+e;if(!k(g))break;f=a.pages[g].f;h=m(g,"w");v=m(g,"h");l=a.fixedHeightGrid?(a.rowHeight-a.fixedPadding)*h/v:a.gridPageWidth;h=a.fixedHeightGrid?a.rowHeight-a.fixedPadding:l/h*v;v=parseInt(e*(a.fixedPadding+a.gridPageWidth)+a.fixedPadding,
10);l=parseInt(l,10);h=parseInt(h,10);v+=a.fixedHeightGrid?(a.gridPageWidth-l)/2:0;f=a.iipServerURL+"?FIF="+x+f+"&amp;HEI="+(h+2)+"&amp;CVT=JPEG";d.push('<div id="'+a.ID+"page-"+g+'" class="diva-page" style="width: '+l+"px; height: "+h+"px; left: "+v+'px;" title="Page '+(g+1)+'"></div>');H(c,g,f,l,h)}d.push("</div>");b(document.getElementById(a.ID+"inner")).append(d.join(""))}},u=function(c){b(document.getElementById(a.ID+"row-"+c)).empty().remove()},F=function(b,c){0<c?t(b)&&(p(b)?(w(b),a.lastRowLoaded=
b,F(a.lastRowLoaded+1,c)):a.rowHeight*(b+1)<a.topScrollSoFar&&F(b+1,c)):t(b)&&(p(b)?(w(b),a.firstRowLoaded=b,F(a.firstRowLoaded-1,c)):a.rowHeight*b>a.topScrollSoFar+a.panelHeight&&F(b-1,c))},G=function(b,c){0<c?t(b)&&a.rowHeight*(b+1)<a.topScrollSoFar&&(u(b),a.firstRowLoaded++,G(a.firstRowLoaded,c)):t(b)&&a.rowHeight*b>a.topScrollSoFar+a.panelHeight&&(u(b),a.lastRowLoaded--,G(a.lastRowLoaded,c))},H=function(c,d,e,g,f){a.pageTimeouts.push(setTimeout(function(){p(c)&&b(a.selector+"page-"+d).html('<img src="'+
e+'" style="width: '+g+"px; height: "+f+'px;" />')},a.rowLoadTimeout))},v=function(b){var c=a.topScrollSoFar+a.panelHeight/2,d=a.currentPageIndex,e=a.currentPageIndex+b,g=!1;0>b?0<=e&&a.heightAbovePages[e]+m(e,"h")+a.verticalPadding>=c&&(g=!0):0<b&&a.heightAbovePages[d]+m(d,"h")+a.verticalPadding<c&&(g=!0);return g?(a.currentPageIndex=e,0===b||v(b)||(b=a.pages[e].f,h(a.onSetCurrentPage,e,b),diva.Events.publish("VisiblePageDidChange",[e,b])),!0):!1},I=function(b){var c=Math.floor(a.currentPageIndex/
...
c;diva.Events.publish("VisiblePageDidChange",[c,a.pages[c].f])},Q=function(b){return b>=a.minZoomLevel&&b<=a.maxZoomLevel?b:a.minZoomLevel},A=function(b){return b>=a.minPagesPerRow&&b<=a.maxPagesPerRow?b:a.maxPagesPerRow},N=function(){a.allTilesLoaded=[];b(a.outerSelector).scrollTop(0);a.topScrollSoFar=0;b(a.innerSelector).empty();a.firstPageLoaded=0;a.firstRowLoaded=-1;a.previousTopScroll=0;for(clearTimeout(a.resizeTimer);a.pageTimeouts.length;)clearTimeout(a.pageTimeouts.pop())},z=function(){a.inGrid?
K():J()},J=function(){N();a.zoomLevel=Q(a.zoomLevel);var c=a.zoomLevel;0<a.adaptivePadding?(a.horizontalPadding=a.averageWidths[c]*a.adaptivePadding,a.verticalPadding=a.averageHeights[c]*a.adaptivePadding):(a.horizontalPadding=a.fixedPadding,a.verticalPadding=a.fixedPadding);a.pageTools.length&&(a.verticalPadding=Math.max(40,a.horizontalPadding));a.totalHeight=a.totalHeights[c]+a.verticalPadding*(a.numPages+1);a.dimAfterZoom=a.totalHeight;var d=Math.max(a.maxWidths[c]+2*a.horizontalPadding,a.panelWidth),
...
a.scrollbarWidth),a.panelWidth=newWidth,a.panelHeight=newHeight,!0):!1},aa=function(){b(a.outerSelector+", "+a.innerSelector).dragscrollable({dragSelector:".diva-dragger",acceptPropagatedEvent:!0});b(a.outerSelector).on("dblclick",".diva-document-page",function(a){Z.call(this,a)});b(a.outerSelector).on("contextmenu",".diva-document-page",function(b){if(b.ctrlKey)return clearTimeout(a.singleClickTimeout),a.singleClick?(Z.call(this,b),a.singleClick=!1):(a.singleClick=!0,a.singleClickTimeout=setTimeout(function(){a.singleClick=
!1},500)),!1});b(a.outerSelector).on("dblclick",".diva-row",function(b){var c=document.getElementById(a.ID+"outer");a.goDirectlyTo=Math.floor((b.pageY-a.viewerYOffset+c.scrollTop)/a.rowHeight)*a.pagesPerRow+Math.floor((b.pageX-a.viewerXOffset+c.scrollLeft)/(a.panelWidth/a.pagesPerRow));a.inGrid=!1;O()})},ca=function(){b(a.innerSelector).mouseover(function(){b(this).removeClass("diva-grabbing").addClass("diva-grab")});b(a.innerSelector).mouseout(function(){b(this).removeClass("diva-grab")});b(a.innerSelector).mousedown(function(){b(this).removeClass("diva-grab").addClass("diva-grabbing")});
b(a.innerSelector).mouseup(function(){b(this).removeClass("diva-grabbing").addClass("diva-grab")});aa();b(a.outerSelector).scroll(function(){a.topScrollSoFar=document.getElementById(a.ID+"outer").scrollTop;var c=a.topScrollSoFar-a.previousTopScroll;if(a.inGrid)0>c?(F(a.firstRowLoaded,-1),I(-1),G(a.lastRowLoaded,-1)):0<c&&(F(a.lastRowLoaded,1),I(1),G(a.firstRowLoaded,1)),h(a.onScroll,a.topScrollSoFar),diva.Events.publish("ViewerDidScroll",[a.topScrollSoFar]),0<c?(h(a.onScrollDown,a.topScrollSoFar),
diva.Events.publish("ViewerDidScrollDown",[a.topScrollSoFar])):0>c&&(h(a.onScrollUp,a.topScrollSoFar),diva.Events.publish("ViewerDidScrollUp",[a.topScrollSoFar]));else{var d;if(0>c)r(a.firstPageLoaded,c),v(-1),L(a.lastPageLoaded,c);else if(0<c)r(a.lastPageLoaded,c),v(1),L(a.firstPageLoaded,c);else{var e=a.lastPageLoaded;for(d=Math.max(a.firstPageLoaded,0);d<=e;d++)n(d)&&q(d)}h(a.onScroll,a.topScrollSoFar);diva.Events.publish("ViewerDidScroll",[a.topScrollSoFar]);0<c?(h(a.onScrollDown,a.topScrollSoFar),
diva.Events.publish("ViewerDidScrollDown",[a.topScrollSoFar])):0>c&&(h(a.onScrollUp,a.topScrollSoFar),diva.Events.publish("ViewerDidScrollUp",[a.topScrollSoFar]));a.leftScrollSoFar=b(this).scrollLeft()}a.previousTopScroll=a.topScrollSoFar});if(a.mobileWebkit){var c=[];c.push('<meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1, maximum-scale=1" />');c.push('<meta name="apple-mobile-web-app-capable" content="yes" />');c.push('<meta name="apple-mobile-web-app-status-bar-style" content="black" />');
b("head").append(c.join("\n"));a.blockMobileMove&&b("body").bind("touchmove",function(a){a.originalEvent.preventDefault();return!1});b("body").bind("gestureend",function(b){b=b.originalEvent;if(!a.scaleWait)if(a.goDirectlyTo=a.currentPageIndex,a.inGrid)a.inGrid=!1,O();else a:{var c=a.zoomLevel;if(1<b.scale&&c<a.maxZoomLevel)c++;else if(1>b.scale&&c>a.minZoomLevel)c--;else break a;a.scaleWait=!0;M(c)}return!1});b(window).bind("orientationchange",function(b){a.orientationChange=!0;T();a.goDirectlyTo=
a.currentPageIndex;z()});b(a.outerSelector).kinetic()}if(a.enableSpaceScroll||a.enableKeyScroll){var d=b.ui.keyCode.UP,e=b.ui.keyCode.DOWN,g=b.ui.keyCode.LEFT,f=b.ui.keyCode.RIGHT,k=b.ui.keyCode.SPACE,l=b.ui.keyCode.PAGE_UP,m=b.ui.keyCode.PAGE_DOWN,x=b.ui.keyCode.HOME,y=b.ui.keyCode.END;b(document).keydown(function(c){if(a.enableSpaceScroll&&c.keyCode===k||a.enableKeyScroll&&c.keyCode===m)return b(a.outerSelector).scrollTop(a.topScrollSoFar+a.panelHeight),!1;if(a.enableKeyScroll&&c.keyCode===l)return b(a.outerSelector).scrollTop(a.topScrollSoFar-
a.panelHeight),!1;if(a.enableKeyScroll&&c.keyCode===d)return b(a.outerSelector).scrollTop(a.topScrollSoFar-a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===e)return b(a.outerSelector).scrollTop(a.topScrollSoFar+a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===g)return b(a.outerSelector).scrollLeft(a.leftScrollSoFar-a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===f)return b(a.outerSelector).scrollLeft(a.leftScrollSoFar+a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===
x)return b(a.outerSelector).scrollTop(0),!1;if(a.enableKeyScroll&&c.keyCode===y)return b(a.outerSelector).scrollTop(a.totalHeight),!1});a.mobileWebkit||b(window).resize(function(){var b;a.inFullscreen?(a.panelWidth=window.innerWidth-a.scrollbarWidth,a.panelHeight=window.innerHeight,b=!0):b=U();b&&(clearTimeout(a.resizeTimer),a.resizeTimer=setTimeout(function(){a.goDirectlyTo=a.currentPageIndex;z()},200))})}},da=function(){var c='<div id="'+a.ID+'tools-left" class="diva-tools-left">'+("slider"===a.enableZoomControls?
'<div id="'+a.ID+'zoom-slider"></div>':"")+("buttons"===a.enableZoomControls?'<div id="'+a.ID+'zoom-out-button" class="diva-zoom-out-button zoom-button" title="Zoom Out"></div><div id="'+a.ID+'zoom-in-button" class="diva-zoom-in-button zoom-button" title="Zoom In"></div>':"")+("slider"===a.enableGridControls?'<div id="'+a.ID+'grid-slider"></div>':"")+("buttons"===a.enableGridControls?'<div id="'+a.ID+'grid-out-button" class="diva-grid-out-button grid-button" title="Zoom Out"></div><div id="'+a.ID+
'grid-in-button" class="diva-grid-in-button grid-button" title="Zoom In"></div>':"")+("slider"===a.enableZoomControls?'<div id="'+a.ID+'zoom-slider-label" class="diva-slider-label">Zoom level: <span id="'+a.ID+'zoom-level">'+a.zoomLevel+"</span></div>":"")+("buttons"===a.enableZoomControls?'<div id="'+a.ID+'zoom-buttons-label" class="diva-buttons-label">Zoom level: <span id="'+a.ID+'zoom-level">'+a.zoomLevel+"</span></div>":"")+("slider"===a.enableGridControls?'<div id="'+a.ID+'grid-slider-label" class="diva-slider-label">Pages per row: <span id="'+
a.ID+'pages-per-row">'+a.pagesPerRow+"</span></div>":"")+("buttons"===a.enableGridControls?'<div id="'+a.ID+'grid-buttons-label" class="diva-buttons-label">Pages per row: <span id="'+a.ID+'pages-per-row">'+a.pagesPerRow+"</span></div>":"")+'</div><div id="'+a.ID+'tools-right" class="diva-tools-right">'+(a.enableFullscreen?'<div id="'+a.ID+'fullscreen" class="diva-fullscreen-icon" title="Toggle fullscreen mode"></div>':"")+(a.enableLinkIcon?'<div class="diva-link-icon" id="'+a.ID+'link-icon" style="'+
(a.enableGridIcon?"border-left: 0px":"")+'" title="Link to this page"></div>':"")+(a.enableGridIcon?'<div class="diva-grid-icon'+(a.inGrid?" diva-in-grid":"")+'" id="'+a.ID+'grid-icon" title="Toggle grid view"></div>':"")+'<div class="diva-page-nav">'+(a.enableGotoPage?'<form id="'+a.ID+'goto-page" class="diva-goto-form"><input type="text" id="'+a.ID+'goto-page-input" / class="diva-input"> <input type="submit" value="Go" style="margin-top: 0px;" /></form>':"")+('<div class="diva-page-label">Page <span id="'+
a.ID+'current-page">1</span> of <span id="'+a.ID+'num-pages">'+a.numPages+"</span></div>")+"</div></div>";a.toolbarParentSelector?b(a.toolbarParentSelector).prepend('<div id="'+a.ID+'tools" class="diva-tools">'+c+"</div>"):b(a.parentSelector).prepend('<div id="'+a.ID+'tools" class="diva-tools">'+c+"</div>");b(a.selector+"zoom-slider").slider({value:a.zoomLevel,min:a.minZoomLevel,max:a.maxZoomLevel,step:1,slide:function(c,d){var e=a.currentPageIndex;a.goDirectlyTo=e;var g=Math.pow(2,d.value-a.zoomLevel),
f=a.maxWidths[a.zoomLevel]+2*a.horizontalPadding,h=b(a.outerSelector).scrollLeft()-(f-a.panelWidth)/2;a.horizontalOffset=f>a.panelWidth?h*g:0;a.verticalOffset=g*(b(a.outerSelector).scrollTop()-a.heightAbovePages[e]);M(d.value)},change:function(b,c){c.value!==a.zoomLevel&&M(c.value)},stop:function(a,c){b(".ui-slider-handle").blur()}});var d=function(c){var d=a.currentPageIndex;a.goDirectlyTo=d;var e=Math.pow(2,a.zoomLevel-1-a.zoomLevel),g=a.maxWidths[a.zoomLevel]+2*a.horizontalPadding,f=b(a.outerSelector).scrollLeft()-
(g-a.panelWidth)/2;a.horizontalOffset=g>a.panelWidth?f*e:0;a.verticalOffset=e*(b(a.outerSelector).scrollTop()-a.heightAbovePages[d]);M(a.zoomLevel+c)};b(a.selector+"zoom-out-button").click(function(){d(-1)});b(a.selector+"zoom-in-button").click(function(){d(1)});b(a.selector+"grid-slider").slider({value:a.pagesPerRow,min:a.minPagesPerRow,max:a.maxPagesPerRow,step:1,slide:function(a,b){B(b.value)},change:function(b,c){c.value!==a.pagesPerRow&&B(c.value)}});b(a.selector+"fullscreen").click(function(){S()});
b(a.selector+"grid-out-button").click(function(){B(a.pagesPerRow+1)});b(a.selector+"grid-in-button").click(function(){B(a.pagesPerRow-1)});b(a.selector+"grid-icon").click(function(){P()});b(a.selector+"goto-page").submit(function(){var c=parseInt(b(a.selector+"goto-page-input").val(),10)-1;k(c)?a.inGrid?x(c):y(c,0,0):alert("Invalid page number");return!1});b(a.selector+"link-icon").click(function(){b("body").prepend('<div id="'+a.ID+'link-popup" class="diva-link-popup"><input id="'+a.ID+'link-popup-input" class="diva-input" type="text" value="'+
...
b(a.parentSelector).siblings().not("#diva-canvas-backdrop")[0]||(a.divaIsFullWindow=!0);a.mobileWebkit?T():(a.divaIsFullWindow?(a.widthProportion=b(a.parentSelector).width()/b(window).innerWidth(),a.heightProportion=Math.min(.9,b(a.parentSelector).height()/b(window).innerHeight())):(a.widthProportion=b(a.parentSelector).width()/b(a.parentSelector).parent().innerWidth(),a.heightProportion=b(a.parentSelector).height()/b(a.parentSelector).parent().innerHeight()),U());c=b(a.outerSelector).offset();a.viewerXOffset=
c.left;a.viewerYOffset=c.top;a.enableAutoWidth&&(a.mobileWebkit?(c=parseInt(b("body").css("margin")),b(a.outerSelector).css("margin-left",a.viewerWidthPadding-c)):b(a.outerSelector).css("margin-left",a.viewerWidthPadding));a.inFullscreen?V(!1):z();h(a.onReady,a);diva.Events.publish("ViewerDidLoad",[a]);a.loaded=!0}})},W=function(){return a.loaded?!0:(console.warn("The viewer is not completely initialized. This is likely because it is still downloading data. To fix this, only call this function if the isReady() method returns true."),
!1)};(function(){a.scrollbarWidth=b.getScrollbarWidth();a.mobileWebkit=void 0!==window.orientation;a.ID=b.generateId("diva-");a.selector="#"+a.ID;var c=parseInt(a.ID,10);1<c&&(a.hashParamSuffix=c);a.outerSelector=a.selector+"outer";a.innerSelector=a.selector+"inner";b(a.parentSelector).append('<div id="'+a.ID+'outer" class="diva-outer"></div>');b(a.outerSelector).append('<div id="'+a.ID+'inner" class="diva-inner diva-dragger"></div>');c=parseInt(b.getHashParam("n"+a.hashParamSuffix),10);c>=a.minPagesPerRow&&
c<=a.maxPagesPerRow&&(a.pagesPerRow=c);c=b.getHashParam("z"+a.hashParamSuffix);""!==c&&(c=parseInt(c,10),c>=a.minZoomLevel&&(a.zoomLevel=c));c=parseInt(b.getHashParam("y"+a.hashParamSuffix),10);isNaN(c)||(a.verticalOffset=c);c=parseInt(b.getHashParam("x"+a.hashParamSuffix),10);isNaN(c)||(a.horizontalOffset=c);var c=b.getHashParam("g"+a.hashParamSuffix),d="true"===c,e=b.getHashParam("f"+a.hashParamSuffix);a.inGrid=a.inGrid&&"false"!==c||d;a.inFullscreen=a.inFullscreen&&"false"!==e||"true"===e;a.minHeight=
parseInt(b(a.outerSelector).css("min-height"),10);a.minWidth=parseInt(b(a.outerSelector).css("min-width"),10);fa();ea();ca()})();this.getItemTitle=function(){return a.itemTitle};this.gotoPageByNumber=function(a){a-=1;return k(a)?(y(a,0,0),!0):!1};this.gotoPageByIndex=function(a){return k(a)?(y(a,0,0),!0):!1};this.getCurrentPage=function(){console.warn("The call to getCurrentPage is deprecated. Use getCurrentPageIndex instead.");return a.currentPageIndex};this.getNumberOfPages=function(){return W()?
a.numPages:!1};this.getPageDimensionsAtZoomLevel=function(b,c){if(!W())return!1;c>a.maxZoomLevel&&(c=a.maxZoomLevel);var d=a.pages[b].d[parseInt(c,10)];return{width:d.w,height:d.h}};this.getCurrentPageDimensionsAtCurrentZoomLevel=function(){return this.getPageDimensionsAtZoomLevel(a.currentPageIndex,a.zoomLevel)};this.isReady=function(){return a.loaded};this.getCurrentPageIndex=function(){return a.currentPageIndex};this.getCurrentPageFilename=function(){return a.pages[a.currentPageIndex].f};this.getCurrentPageNumber=
function(){return a.currentPageIndex+1};this.getZoomLevel=function(){return a.zoomLevel};this.getMaxZoomLevel=function(){return a.maxZoomLevel};this.getMaxZoomLevelForPage=function(b){return W?a.pages[b].m:!1};this.getMinZoomLevel=function(){return a.minZoomLevel};this.setZoomLevel=function(b){a.inGrid&&P();return M(b)};this.zoomIn=function(){return this.setZoomLevel(a.zoomLevel+1)};this.zoomOut=function(){return this.setZoomLevel(a.zoomLevel-1)};this.inViewport=function(b,c,d){b=a.heightAbovePages[b-
1]+c;return l(b,b+d)};this.toggleFullscreenMode=function(){S()};this.enterFullscreenMode=function(){return a.inFullscreen?!1:(S(),!0)};this.leaveFullscreenMode=function(){return a.inFullscreen?(S(),!0):!1};this.toggleGridView=function(){P()};this.enterGridView=function(){return a.inGrid?!1:(P(),!0)};this.leaveGridView=function(){return a.inGrid?(P(),!0):!1};this.gotoPageByName=function(a){a=f(a);return k(a)?(y(a,0,0),!0):!1};this.getPageIndex=function(a){return f(a)};this.getCurrentURL=function(){return E()};
this.getURLHash=function(){return D()};this.getState=function(){return C()};this.getInstanceSelector=function(){return a.selector};this.getInstanceId=function(){return a.ID};this.getSettings=function(){return a};this.translateFromMaxZoomLevel=function(b){return b/Math.pow(2,a.maxZoomLevel-a.zoomLevel)};this.translateToMaxZoomLevel=function(b){var c=a.maxZoomLevel-a.zoomLevel;return 0===c?b:b*Math.pow(2,c)};this.setState=function(b){var c;c=f(b.i);k(c)?a.goDirectlyTo=c:k(b.p)&&(a.goDirectlyTo=b.p);
a.horizontalOffset=parseInt(b.x,10);a.verticalOffset=parseInt(b.y,10);b.z>=a.minZoomLevel&&b.z<=a.maxZoomLevel&&(a.zoomLevel=b.z);b.n>=a.minPagesPerRow&&b.n<=a.maxPagesPerRow&&(a.pagesPerRow=b.n);a.inFullscreen!==b.f?(a.inFullscreen=b.f,V(a.inGrid!==b.g)):a.inGrid!==b.g?(a.inGrid=b.g,O()):z()};this.enableScrollable=function(){a.isScrollable||(aa(),a.isScrollable=!0)};this.disableScrollable=function(){a.isScrollable&&(b(a.innerSelector+".diva-dragger").unbind("mousedown"),b(a.outerSelector).unbind("dblclick"),
...
d.mapSize,d.mapSize),b("#diva-map-viewbox").show(),r());k();n(e);F();"function"===typeof f&&f.call(f)}},t=function(){var a=g[h],c=a.current,a=a.transform?a.transform(c):c;b("#diva-canvas-value").html(a)},p=function(){b("#diva-canvas-slider").slider({value:g[h].current})},w=function(a){a=d.zoomWidthRatio*Math.pow(2,a);return d.proxyURL?d.proxyURL+"?f="+d.filename+"&w="+a:d.iipServerURL+"?FIF="+(d.imageDir+"/")+d.filename+"&WID="+a+"&CVT=JPEG"},u=function(){(2<g.zoom.current||d.mobileWebkit)&&b(d.selector+
"throbber").addClass("canvas-throbber").show()},F=function(){b(d.selector+"throbber").removeClass("canvas-throbber").hide()},G=function(){var a={},b=!1,c=d.localStoragePrefix+d.filename,e;for(e in g)g[e].previous!==g[e].initial&&(a[e]=g[e].previous,b=!0);b?(d.pluginIcon.addClass("new"),localStorage.setObject(c,a)):(d.pluginIcon.removeClass("new"),localStorage.removeItem(c))},H=function(a,b){d.zoomLevel=a;var g=w(a);L(g,function(){c.scaleFactor=c.size/e.size;r();G()})};return{init:function(a,f){if(!window.HTMLCanvasElement)return!1;
...
c);b("#diva-canvas-value").html(d)};z("contrast");b("#diva-canvas-slider").slider({slide:function(a,b){g[h].current=b.value;t();k()}});b("#diva-canvas-reset-all").click(function(){for(var a in g)g[a].current=g[a].initial;t();p();k()});b("#diva-canvas-reset").click(function(){g[h].current=g[h].initial;t();p();k()});b("#diva-canvas-apply").click(function(){l()&&(u(),setTimeout(function(){g.zoom.current!==g.zoom.previous?H(g.zoom.current):(n(),F(),G())},d.throbberTimeout))});b("#diva-canvas-close").click(function(){b("body").removeClass("overflow-hidden");

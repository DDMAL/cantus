...
c=b(a.outerSelector).offset();a.viewerXOffset=c.left;a.viewerYOffset=c.top;d=parseInt(b(a.outerSelector).css("border-top-width"))+parseInt(b(a.outerSelector).css("border-bottom-width"));c=b(a.parentSelector).height();var e=b(a.parentSelector).offset().top;c=a.enableAutoHeight?c-a.viewerYOffset+e-d:b(a.outerSelector).outerHeight();e=parseInt(b(a.outerSelector).css("border-left-width"))+parseInt(b(a.outerSelector).css("border-right-width"));d=b(a.parentSelector).width();d=a.enableAutoWidth?d-2*a.viewerWidthPadding-
e-a.scrollbarWidth:b(a.outerSelector).width()-a.scrollbarWidth-e;return d!==a.panelWidth||c!==a.panelHeight?(a.enableAutoHeight&&b(a.outerSelector).height(c),a.enableAutoWidth&&b(a.outerSelector).width(d+a.scrollbarWidth),a.panelWidth=d,a.panelHeight=c,!0):!1},aa=function(){b(a.outerSelector+", "+a.innerSelector).dragscrollable({dragSelector:".diva-dragger",acceptPropagatedEvent:!0});b(a.outerSelector).on("dblclick",".diva-document-page",function(a){Z.call(this,a)});b(a.outerSelector).on("contextmenu",
".diva-document-page",function(b){if(b.ctrlKey)return clearTimeout(a.singleClickTimeout),a.singleClick?(Z.call(this,b),a.singleClick=!1):(a.singleClick=!0,a.singleClickTimeout=setTimeout(function(){a.singleClick=!1},500)),!1});b(a.outerSelector).on("dblclick",".diva-row",function(b){var c=document.getElementById(a.ID+"outer");a.goDirectlyTo=Math.floor((b.pageY-a.viewerYOffset+c.scrollTop)/a.rowHeight)*a.pagesPerRow+Math.floor((b.pageX-a.viewerXOffset+c.scrollLeft)/(a.panelWidth/a.pagesPerRow));a.inGrid=
!1;O()})},ca=function(){b(a.innerSelector).mouseover(function(){b(this).removeClass("diva-grabbing").addClass("diva-grab")});b(a.innerSelector).mouseout(function(){b(this).removeClass("diva-grab")});b(a.innerSelector).mousedown(function(){b(this).removeClass("diva-grab").addClass("diva-grabbing")});b(a.innerSelector).mouseup(function(){b(this).removeClass("diva-grabbing").addClass("diva-grab")});aa();b(a.outerSelector).scroll(function(){a.topScrollSoFar=document.getElementById(a.ID+"outer").scrollTop;
var c=a.topScrollSoFar-a.previousTopScroll;if(a.inGrid)0>c?(F(a.firstRowLoaded,-1),I(-1),G(a.lastRowLoaded,-1)):0<c&&(F(a.lastRowLoaded,1),I(1),G(a.firstRowLoaded,1)),k(a.onScroll,a.topScrollSoFar),diva.Events.publish("ViewerDidScroll",[a.topScrollSoFar]),0<c?(k(a.onScrollDown,a.topScrollSoFar),diva.Events.publish("ViewerDidScrollDown",[a.topScrollSoFar])):0>c&&(k(a.onScrollUp,a.topScrollSoFar),diva.Events.publish("ViewerDidScrollUp",[a.topScrollSoFar]));else{var d;if(0>c)r(a.firstPageLoaded,c),v(-1),
L(a.lastPageLoaded,c);else if(0<c)r(a.lastPageLoaded,c),v(1),L(a.firstPageLoaded,c);else{var e=a.lastPageLoaded;for(d=Math.max(a.firstPageLoaded,0);d<=e;d++)n(d)&&q(d)}k(a.onScroll,a.topScrollSoFar);diva.Events.publish("ViewerDidScroll",[a.topScrollSoFar]);0<c?(k(a.onScrollDown,a.topScrollSoFar),diva.Events.publish("ViewerDidScrollDown",[a.topScrollSoFar])):0>c&&(k(a.onScrollUp,a.topScrollSoFar),diva.Events.publish("ViewerDidScrollUp",[a.topScrollSoFar]));a.leftScrollSoFar=b(this).scrollLeft()}a.previousTopScroll=
a.topScrollSoFar});if(a.mobileWebkit){var c=[];c.push('<meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1, maximum-scale=1" />');c.push('<meta name="apple-mobile-web-app-capable" content="yes" />');c.push('<meta name="apple-mobile-web-app-status-bar-style" content="black" />');b("head").append(c.join("\n"));a.blockMobileMove&&b("body").bind("touchmove",function(a){a.originalEvent.preventDefault();return!1});b("body").bind("gestureend",function(b){b=b.originalEvent;
if(!a.scaleWait)if(a.goDirectlyTo=a.currentPageIndex,a.inGrid)a.inGrid=!1,O();else a:{var c=a.zoomLevel;if(1<b.scale&&c<a.maxZoomLevel)c++;else if(1>b.scale&&c>a.minZoomLevel)c--;else break a;a.scaleWait=!0;M(c)}return!1});b(window).bind("orientationchange",function(b){a.orientationChange=!0;T();a.goDirectlyTo=a.currentPageIndex;z()});b(a.outerSelector).kinetic()}if(a.enableSpaceScroll||a.enableKeyScroll){var d=b.ui.keyCode.UP,e=b.ui.keyCode.DOWN,g=b.ui.keyCode.LEFT,f=b.ui.keyCode.RIGHT,h=b.ui.keyCode.SPACE,
l=b.ui.keyCode.PAGE_UP,m=b.ui.keyCode.PAGE_DOWN,x=b.ui.keyCode.HOME,y=b.ui.keyCode.END;b(document).keydown(function(c){if(a.enableSpaceScroll&&c.keyCode===h||a.enableKeyScroll&&c.keyCode===m)return b(a.outerSelector).scrollTop(a.topScrollSoFar+a.panelHeight),!1;if(a.enableKeyScroll&&c.keyCode===l)return b(a.outerSelector).scrollTop(a.topScrollSoFar-a.panelHeight),!1;if(a.enableKeyScroll&&c.keyCode===d)return b(a.outerSelector).scrollTop(a.topScrollSoFar-a.arrowScrollAmount),!1;if(a.enableKeyScroll&&
c.keyCode===e)return b(a.outerSelector).scrollTop(a.topScrollSoFar+a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===g)return b(a.outerSelector).scrollLeft(a.leftScrollSoFar-a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===f)return b(a.outerSelector).scrollLeft(a.leftScrollSoFar+a.arrowScrollAmount),!1;if(a.enableKeyScroll&&c.keyCode===x)return b(a.outerSelector).scrollTop(0),!1;if(a.enableKeyScroll&&c.keyCode===y)return b(a.outerSelector).scrollTop(a.totalHeight),!1});a.mobileWebkit||
b(window).resize(function(){var b;a.inFullscreen?(a.panelWidth=window.innerWidth-a.scrollbarWidth,a.panelHeight=window.innerHeight,b=!0):b=U();b&&(clearTimeout(a.resizeTimer),a.resizeTimer=setTimeout(function(){a.goDirectlyTo=a.currentPageIndex;z()},200))})}},da=function(){var c='<div id="'+a.ID+'tools-left" class="diva-tools-left">'+("slider"===a.enableZoomControls?'<div id="'+a.ID+'zoom-slider"></div>':"")+("buttons"===a.enableZoomControls?'<div id="'+a.ID+'zoom-out-button" class="diva-zoom-out-button zoom-button" title="Zoom Out"></div><div id="'+
a.ID+'zoom-in-button" class="diva-zoom-in-button zoom-button" title="Zoom In"></div>':"")+("slider"===a.enableGridControls?'<div id="'+a.ID+'grid-slider"></div>':"")+("buttons"===a.enableGridControls?'<div id="'+a.ID+'grid-out-button" class="diva-grid-out-button grid-button" title="Zoom Out"></div><div id="'+a.ID+'grid-in-button" class="diva-grid-in-button grid-button" title="Zoom In"></div>':"")+("slider"===a.enableZoomControls?'<div id="'+a.ID+'zoom-slider-label" class="diva-slider-label">Zoom level: <span id="'+
a.ID+'zoom-level">'+a.zoomLevel+"</span></div>":"")+("buttons"===a.enableZoomControls?'<div id="'+a.ID+'zoom-buttons-label" class="diva-buttons-label">Zoom level: <span id="'+a.ID+'zoom-level">'+a.zoomLevel+"</span></div>":"")+("slider"===a.enableGridControls?'<div id="'+a.ID+'grid-slider-label" class="diva-slider-label">Pages per row: <span id="'+a.ID+'pages-per-row">'+a.pagesPerRow+"</span></div>":"")+("buttons"===a.enableGridControls?'<div id="'+a.ID+'grid-buttons-label" class="diva-buttons-label">Pages per row: <span id="'+
a.ID+'pages-per-row">'+a.pagesPerRow+"</span></div>":"")+'</div><div id="'+a.ID+'tools-right" class="diva-tools-right">'+(a.enableFullscreen?'<div id="'+a.ID+'fullscreen" class="diva-fullscreen-icon" title="Toggle fullscreen mode"></div>':"")+(a.enableLinkIcon?'<div class="diva-link-icon" id="'+a.ID+'link-icon" style="'+(a.enableGridIcon?"border-left: 0px":"")+'" title="Link to this page"></div>':"")+(a.enableGridIcon?'<div class="diva-grid-icon'+(a.inGrid?" diva-in-grid":"")+'" id="'+a.ID+'grid-icon" title="Toggle grid view"></div>':
"")+'<div class="diva-page-nav">'+(a.enableGotoPage?'<form id="'+a.ID+'goto-page" class="diva-goto-form"><input type="text" id="'+a.ID+'goto-page-input" / class="diva-input"> <input type="submit" value="Go" style="margin-top: 0px;" /></form>':"")+('<div class="diva-page-label">Page <span id="'+a.ID+'current-page">1</span> of <span id="'+a.ID+'num-pages">'+a.numPages+"</span></div>")+"</div></div>";a.toolbarParentSelector?b(a.toolbarParentSelector).prepend('<div id="'+a.ID+'tools" class="diva-tools">'+
...
!0);a.mobileWebkit?T():(a.divaIsFullWindow?(a.widthProportion=b(a.parentSelector).width()/b(window).innerWidth(),a.heightProportion=Math.min(.9,b(a.parentSelector).height()/b(window).innerHeight())):(a.widthProportion=b(a.parentSelector).width()/b(a.parentSelector).parent().innerWidth(),a.heightProportion=b(a.parentSelector).height()/b(a.parentSelector).parent().innerHeight()),U());a.enableAutoWidth&&(a.mobileWebkit?(c=parseInt(b("body").css("margin")),b(a.outerSelector).css("margin-left",a.viewerWidthPadding-
c)):b(a.outerSelector).css("margin-left",a.viewerWidthPadding));a.inFullscreen?V(!1):z();k(a.onReady,a);diva.Events.publish("ViewerDidLoad",[a]);a.loaded=!0}})},W=function(){return a.loaded?!0:(console.warn("The viewer is not completely initialized. This is likely because it is still downloading data. To fix this, only call this function if the isReady() method returns true."),!1)};(function(){a.scrollbarWidth=b.getScrollbarWidth();a.mobileWebkit=void 0!==window.orientation;a.ID=b.generateId("diva-");
a.selector="#"+a.ID;var c=parseInt(a.ID,10);1<c&&(a.hashParamSuffix=c);a.outerSelector=a.selector+"outer";a.innerSelector=a.selector+"inner";b(a.parentSelector).append('<div id="'+a.ID+'outer" class="diva-outer"></div>');b(a.outerSelector).append('<div id="'+a.ID+'inner" class="diva-inner diva-dragger"></div>');c=parseInt(b.getHashParam("n"+a.hashParamSuffix),10);c>=a.minPagesPerRow&&c<=a.maxPagesPerRow&&(a.pagesPerRow=c);c=b.getHashParam("z"+a.hashParamSuffix);""!==c&&(c=parseInt(c,10),c>=a.minZoomLevel&&
(a.zoomLevel=c));c=parseInt(b.getHashParam("y"+a.hashParamSuffix),10);isNaN(c)||(a.verticalOffset=c);c=parseInt(b.getHashParam("x"+a.hashParamSuffix),10);isNaN(c)||(a.horizontalOffset=c);var c=b.getHashParam("g"+a.hashParamSuffix),d="true"===c,e=b.getHashParam("f"+a.hashParamSuffix);a.inGrid=a.inGrid&&"false"!==c||d;a.inFullscreen=a.inFullscreen&&"false"!==e||"true"===e;a.minHeight=parseInt(b(a.outerSelector).css("min-height"),10);a.minWidth=parseInt(b(a.outerSelector).css("min-width"),10);fa();ea();
ca()})();this.getItemTitle=function(){return a.itemTitle};this.gotoPageByNumber=function(a){a-=1;return f(a)?(y(a,0,0),!0):!1};this.gotoPageByIndex=function(a){return f(a)?(y(a,0,0),!0):!1};this.getCurrentPage=function(){console.warn("The call to getCurrentPage is deprecated. Use getCurrentPageIndex instead.");return a.currentPageIndex};this.getNumberOfPages=function(){return W()?a.numPages:!1};this.getPageDimensionsAtZoomLevel=function(b,c){if(!W())return!1;c>a.maxZoomLevel&&(c=a.maxZoomLevel);var d=
a.pages[b].d[parseInt(c,10)];return{width:d.w,height:d.h}};this.getCurrentPageDimensionsAtCurrentZoomLevel=function(){return this.getPageDimensionsAtZoomLevel(a.currentPageIndex,a.zoomLevel)};this.isReady=function(){return a.loaded};this.getCurrentPageIndex=function(){return a.currentPageIndex};this.getCurrentPageFilename=function(){return a.pages[a.currentPageIndex].f};this.getCurrentPageNumber=function(){return a.currentPageIndex+1};this.getZoomLevel=function(){return a.zoomLevel};this.getMaxZoomLevel=

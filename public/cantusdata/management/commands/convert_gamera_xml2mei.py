...
from cantusdata.helpers.gamera_xml2mei.converter import initializeArgumentParser, main
...
class Command (BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        optparse.make_option('--dump-zone-clusters', action='store_true',
                             help='write a visualization of the zone clusters to file'),

        optparse.make_option('--dump-zone-overlay', nargs=2, metavar='TIFF',
    ...
    def handle(self, *args, **options):
        ...
        if len(args) >= 1:
            ...
            if len(args) == 2:
                ...
                raise ValueError('{} accepts no more than 2 positional arguments'.format(BASE_NAME))

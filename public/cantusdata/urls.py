...
urlpatterns += format_suffix_patterns(
    ...
    url(r'^neumeeditor/names/$', NameList.as_view(), name="name-list"),
    url(r'^neumeeditor/name/(?P<pk>[0-9]+)/$', NameDetail.as_view(),
        name="name-detail"),

    url(r'^neumeeditor/styles/$', StyleList.as_view(), name="style-list"),
    url(r'^neumeeditor/style/(?P<pk>[0-9]+)/$', StyleDetail.as_view(),
        name="style-detail"),

    url(r'^neumeeditor/users/$', UserList.as_view(), name="user-list"),
    url(r'^neumeeditor/user/(?P<pk>[0-9]+)/$', UserDetail.as_view(),
        name="user-detail"),
